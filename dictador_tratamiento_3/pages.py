...
page_sequence = [EnterID, ResultsCompetitiveTask, Introduction, RoleAssignment, Decision, WaitForResults,PerceptionQuestion, ResultsAllocator, ResultsReceiver,FinalPage,FinalQuestionnaire]
